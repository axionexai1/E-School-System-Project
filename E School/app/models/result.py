...
class Result(db.Model):
    ...
    student = db.relationship("Student",backref=db.backref("results",lazy=True,cascade="all, delete-orphan"))
    ...
    teacher = db.relationship("Teacher",backref=db.backref("results",lazy=True))
    classroom = db.relationship("Class",backref=db.backref("results",lazy=True))
    section = db.relationship("Section",backref=db.backref("results",lazy=True))
